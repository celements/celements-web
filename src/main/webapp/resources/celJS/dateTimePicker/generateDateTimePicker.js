(function (window, undefined) {
  ...
  if (
    typeof window.CELEMENTS.DATETIMEPICKER.DateTimePickerGenerator ===
    "undefined"
  ) {
      ...
      generateDateTimePicker: function () {
        ...
        _me._htmlElement
          ...
          .each(function (key, element) {
            ...
            const pickerDataAttrObj = JSON.parse(
              element.getAttribute("data-pickerAttr"),
            );
