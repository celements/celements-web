...
function AdminToolbar() {
  ...
  this.hide = function () {
    ...
    if (this.overlayDiv) {
      for (var i = 60; i >= 0; i--) this.overlayDiv.setOpacity(i);
  ...
  this.resize = function () {
    var docDim = getDocumentDimensions();
    if (me.overlayDiv) me.overlayDiv.setSize(docDim[0], docDim[1]);
    if (me.adminDiv) me.adminDiv.setSize(300, docDim[1] - 12);
  };
}
...
function AdminWindow(parent, parent_node, top, left, height, width, className) {
  ...
  this.AdminWindow = function (
    ...
    this.contentDiv.setSize(
      ...
      this.w - (this.contentDiv.totalw - this.contentDiv.w),
    );
