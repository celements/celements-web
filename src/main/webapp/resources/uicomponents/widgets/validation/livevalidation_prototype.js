...
LiveValidation.prototype = {
  ...
  validateElement: function (validationFunction, validationParamsObj) {
    var value =
      this.elementType == LiveValidation.SELECT
...
LiveValidationForm.prototype = {
  ...
  initialize: function (element) {
    ...
    this.element.onsubmit = function (e) {
      var ret = LiveValidation.massValidate(this.fields)
        ? this.oldOnSubmit.call(this.element, e) !== false
        : false;
      if (!ret) Event.stop(e);
...
var Validate = {
    ...
    switch (true) {
      ...
      case params.minimum !== null && params.maximum !== null:
        Validate.Numericality(value, {
          tooLowMessage: params.tooLowMessage,
          minimum: params.minimum,
        });
        Validate.Numericality(value, {
          tooHighMessage: params.tooHighMessage,
    ...
    switch (true) {
      ...
      case params.minimum !== null && params.maximum !== null:
        Validate.Length(value, {
          tooShortMessage: params.tooShortMessage,
          minimum: params.minimum,
        });
        Validate.Length(value, {
          tooLongMessage: params.tooLongMessage,
          maximum: params.maximum,
        });
        break;
      case params.minimum !== null:
  ...
  Inclusion: function (value, paramsObj) {
    ...
    if ((!params.negate && !found) || (params.negate && found))
      Validate.fail(params.failureMessage);
    return true;
  },
