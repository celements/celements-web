Lightbox = Class.create({
  ...
  roundedlightbottom: function (A, B) {
    var C =
      '<div class="roundedlight"><b class="top"><b class="b4b" style="background:' +
      B +
  ...
  roundedbottom: function (A, B) {
    var C =
      '<div class="rounded"><b class="bottom" style="padding:0px; margin:0px;"><b class="b12b" style="background:' +
      B +
  ...
  roundedlighttop: function (A, B) {
    var C =
      '<div class="roundedlight"><b class="top"><b class="b1" style="background:' +
      B +
  ...
  roundedtop: function (A, B) {
    var C =
      '<div class="rounded"><b class="top"><b class="b1" style="background:' +
      B +
      ';"></b><b class="b2" style="background:' +
      A +
      "; border-color:" +
  ...
  lightboxlink: function (B, A) {
    var C =
      '<a href="#" onclick="javascript:$(\'lb-content\').innerHTML =' +
      A +
